...
class ProjectReportingStepThree105Form extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('pitanje9pp1', ChoiceType::class, array(
                'choices' => array(
                    'DA' => 'DA',
                    'NE' => 'NE',
                    'N/A' => 'N/A',
            ...
            ->add('pitanje9pp2', ChoiceType::class, array(
                'choices' => array(
                    'DA' => 'DA',
                    'NE' => 'NE',
                    'N/A' => 'N/A',
            ...
            ->add('pitanje9pp3', ChoiceType::class, array(
                'choices' => array(
                    'DA' => 'DA',
                    'NE' => 'NE',
                    'N/A' => 'N/A',
            ...
            ->add('pitanje10pp1', ChoiceType::class, array(
                'choices' => array(
                    'DA' => 'DA',
                    'NE' => 'NE',
                    'N/A' => 'N/A',
            ...
            ->add('pitanje10pp2pp1', ChoiceType::class, array(
                'choices' => array(
                    'DA' => 'DA',
                    'NE' => 'NE',
                    'N/A' => 'N/A',
            ...
            ->add('pitanje10pp2pp2', ChoiceType::class, array(
                'choices' => array(
                    'DA' => 'DA',
                    'NE' => 'NE',
                    'N/A' => 'N/A',
            ...
            ->add('pitanje10pp3', ChoiceType::class, array(
                'choices' => array(
                    'DA' => 'DA',
                    'NE' => 'NE',
                    'N/A' => 'N/A',
            ...
            $builder
                ->add('pitanje8pp6', ChoiceType::class, array(
                    'choices' => array(
                        'DA' => 'DA',
                        'NE' => 'NE',
                        'N/A' => 'N/A',
                ...
                ->add('pitanje8pp7', ChoiceType::class, array(
                    'choices' => array(
                        'DA' => 'DA',
                        'NE' => 'NE',
                        'N/A' => 'N/A',
