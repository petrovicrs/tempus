...
function loadResults() {
    var $addEquipmentLink = $('<a href="#" class="btn btn-add btn-success "><span aria-hidden="true"></span>add</a>');
    var $addEquipmentLinkDiv = $('<li></li>').append($addEquipmentLink);

    var $collectionEquipmentHolder = $('ul.equipment');

    $collectionEquipmentHolder.find('li').each(function() {
        $addFormDeleteLink($(this));
    });

    $collectionEquipmentHolder.append($addEquipmentLinkDiv);
    $collectionEquipmentHolder.data('index', $collectionEquipmentHolder.find(':input').length);
